 ...
 * @author Jhon
 */
public class selectInventariosIngresoPanel extends javax.swing.JPanel {
    ...
    public selectInventariosIngresoPanel(vistaPrincipal frame) {
        ...
        for(int i=0;i<= listaMaestroinventariocompleto.size()-1;i++){
            if(listaMaestroinventariocompleto.get(i).getCodigo().toCharArray().length>=6){
                listaMaestroinventariocompletoAux.add(listaMaestroinventariocompleto.get(i));
            }
        }
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if(listaMaestroinventariocompletoSeleccionable.isEmpty()){ // esta es para cuando no se hayan filtrado la lista
            ...
            String idSelect;
            idSelect = listaMaestroinventariocompletoAux.get(filaSelect).getCodigo();
        ...
        //frame.swap(1); // hace el llamado al panel de registro de ingreso
